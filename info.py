...
PICS = (environ.get('PICS', 'https://graph.org/file/70a8d686639e4dfbc57b9.jpg')).split()
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'b323441bc55ef14be63018992134d393a62a9da9')
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'api.shareus.io')
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'PUIAQBIFrydvLhIzAOeGV8yZppu2')
